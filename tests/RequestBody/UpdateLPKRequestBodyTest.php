...
use Darmageddon\RestBpjs\Vclaim\RequestBody\UpdateLPKRequestBody;

final class UpdateLPKRequestBodyTest extends TestCase
{
    public function test_can_create_update_LPK_request_body()
    {
        $sample = <<<SAMPLE
        {
            "request": {
